...
namespace PathologicalGames
{
    ...
    ///		   
    ///	 * Objects aren't destroyed by the DespawnOne() method. Instead, they are
    ...
    public sealed class SpawnPool : MonoBehaviour, IList<Transform>
    {
        ...
        /// <summary>
        /// Not Implimented. Use DespawnOne() to properly manage items that should remain 
        ...
        {
            string msg = "Use DespawnOne() to properly manage items that should " +
        ...
        /// <summary>
        ///	See docs for DespawnOne(Transform instance) for basic functionalty information.
        ///		
        ...
        /// <description>
        /// See docs for DespawnOne(Transform instance). This expands that functionality.
        ...
        private IEnumerator ListenForEmitDespawn(ParticleSystem emitter)
        {
            ...
            yield return new WaitForSeconds(emitter.main.startDelay.constantMin + 0.25f);
    ...
    public class PrefabPool
    {
        ...
        {
            return DespawnInstance(xform, false);
        }
        ...
        internal bool DespawnInstance(Transform xform, bool sendEventMessage)
        {
            ...
            //   This is triggered here because DespawnOne has to occur before
