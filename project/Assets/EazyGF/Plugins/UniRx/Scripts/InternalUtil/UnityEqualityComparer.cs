...
namespace UniRx.InternalUtil
{
    ...
    {
        public static readonly IEqualityComparer<BigInteger> BigInter = new BigInterEqualityComparer();
        ...
        static readonly RuntimeTypeHandle bigInterType = typeof(BigInteger).TypeHandle;
        ...
        static object GetDefaultHelper(Type type)
        {
            ...
            if (t.Equals(bigInterType)) return (object)UnityEqualityComparer.BigInter;
        ...
        sealed class BigInterEqualityComparer : IEqualityComparer<BigInteger>
        {
            public bool Equals(BigInteger self, BigInteger vector)
            {
                return self.Equals(vector) && self.Equals(vector);
            }

            public int GetHashCode(BigInteger obj)
            {
                return obj.GetHashCode() ^ obj.GetHashCode() << 2;
            }
        }
