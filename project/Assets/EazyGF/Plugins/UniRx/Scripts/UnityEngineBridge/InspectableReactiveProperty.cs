...
namespace UniRx
{
    ...
    [Serializable]
    public class BigInterReactiveProperty : ReactiveProperty<BigInteger>
    {
        public BigInterReactiveProperty()
            : base()
        {
           
        }

        public BigInterReactiveProperty(string initialValue)
            : base()
        {
            base.Value=BigInteger.Parse(initialValue);
        }
        public BigInterReactiveProperty(BigInteger initialValue)
            : base()
        {
